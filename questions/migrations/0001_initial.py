# Generated by Django 3.1.3 on 2020-12-28 08:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, default=None, null=True, related_name='like_answers', to=settings.AUTH_USER_MODEL)),
                ('related_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_answers', to='questions.question', verbose_name='سوال مربوطه')),
            ],
            options={
                'verbose_name': 'جواب',
